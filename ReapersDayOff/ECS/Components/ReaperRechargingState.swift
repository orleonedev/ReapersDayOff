...
class ReaperRechargingState: GKState {
    // MARK: Properties
    ...
    override func update(deltaTime seconds: TimeInterval) {
        ...
        */
        if elapsedTime < GameplayConfiguration.Reaper.rechargeDelayWhenInactive { return }
        ...
        let amountToRecharge = GameplayConfiguration.Reaper.rechargeAmountPerSecond * seconds
